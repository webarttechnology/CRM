    ...
    <h4 class="fw-bold py-3 mb-4">{{ __('Update Collection' )}}</h4>
        <div class="row">
          <div class="col-xl">
                  <div class="card mb-4">                  
                    <div class="card-body">
                      <form method="post" action="{{ route('collection.update.success') }}" onsubmit="return valid();">
                      <input type="hidden" name="update_id" id="update_id" value="{{ $data -> id }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                    <label class="form-label" for="currency">{{ __('Currency') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                    <label class="form-label" for="instalment">{{ __('Instalment') }} <span class="text-danger">*</span></label>
                                    <select name="instalment" id="instalment" class="form-control">
                                        <option value="">--Select--</option>
                                        @foreach(instalment() as $key => $val)
                                        <option value="{{ $key }}" {{ $key == $data -> instalment?'Selected':'' }}>{{ $val }}</option>
                                        @endforeach                                   
                                    </select>
                          ...
                          <div class="row">                         
                              ...
                              <div class="col-md-6">
                                    ...
                                    <input  type="date" name="sale_date" id="sale_date" class="form-control" value="{{ $data -> sale_date }}">  
                              ...
                              <div class="col-md-6" >
                               ...
                               <div class="col-md-6" id="div_other_pay">
                                    ...
                                    <input  type="text" name="other_payment_mode" id="other_payment_mode" class="form-control" placeholder="Other payment mode" value="{{ $data -> other_payment_mode }}">              
                              </div>
                          </div>                     
                         <div class="row">
