                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="client_id" id="client_id" class="form-control">
                            ...
                            @foreach ($client as $val)
                                <option value="{{ $val['id'] }}" {{ $data->client_id == $val['id'] ? 'Selected' : '' }}>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        @if ($errors->has('project_name'))
                            <small class="text-danger"
                                id="project_nameerrmsg">{{ $errors->first('project_name') }}</small>
                        @endif
                    </div>
                    <div class="col-md-12 mb-3">
                        ...
                        <select name="project_type" id="project_type" class="form-control"
                            ...
                            @foreach ($project_type as $key => $val)
                                <option value="{{ $key }}" {{ $data->project_type == $key ? 'Selected' : '' }}>
                                    {{ $val }}</option>
                            @endforeach
                        </select>
                        @if ($errors->has('project_type'))
                            <small class="text-danger"
                                id="project_typeerrmsg">{{ $errors->first('project_type') }}</small>
                        @endif
                    </div>
                </div> --}}
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="technology" id="technology" class="form-control">
                            ...
                            @foreach ($technology as $i => $val)
                                <option value="{{ $i }}" {{ $i == $data->technology ? 'Selected' : '' }}>
                                    {{ $val }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="type" id="type" class="form-control" onchange="customerOnchangeEvent()">
                            ...
                            @foreach ($technology_type as $i => $val)
                                <option value="{{ $i }}" {{ $i == $data->type ? 'Selected' : '' }}>
                                    {{ $val }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-12 mb-3" id="div_customer_requirment">
                        <label class="form-label" for="customer_requerment">{{ __('Custom Requirements') }} <span
                                class="text-danger">*</span></label>
                        <input name="customer_requerment" id="customer_requerment" class="form-control"
                            placeholder="Custom Requirements" value="{{ $data->customer_requerment }}">
                    </div>
                    ...
                    <div class="row">
                        <div class="mt-3 col-md-1 mb-3">
                            <div class="form-check">
                                <input type="radio" name="digital_marketing" id="seo" value="SEO"
                                    {{ $data->marketing_plan == 'SEO' ? 'Checked' : '' }} class="form-check-input"
                        ...
                        <div class="form-check mt-3 col-md-1 mb-3">
                            <input type="radio" name="digital_marketing" id="smo" value="SMO"
                                {{ $data->marketing_plan == 'SMO' ? 'Checked' : '' }} class="form-check-input"
                                onclick="smonclickEvent()">
                        ...
                        <div class="form-check mt-3 col-md-2 mb-3">
                            <input type="radio" name="digital_marketing" id="seo_smo" value="SEO_SMO"
                                {{ $data->marketing_plan == 'SEO_SMO' ? 'Checked' : '' }} class="form-check-input"
                                onclick="smonclickEvent()">
                            <label class="form-label" for="seo">{{ __(' SEO + SMO') }} </label>
                        </div>
                        <div class="form-check mt-3 col-md-2 mb-3">
                            <input type="radio" name="digital_marketing" id="google_ads"
                                {{ $data->marketing_plan == 'Google Ads' ? 'Checked' : '' }} value="Google Ads"
                                class="form-check-input" onclick="smonclickEvent()">
                    ...
                    <div class="row mb-3">
                        <div class="mt-3 col-md-2 div_smo mb-3">
                            <input class="form-check-input" type="checkbox" name="smo_platfrom[]" value="Facebook"
                                id="facebook"
                                {{ $data->smo_on && in_array('Facebook', json_decode($data->smo_on)) ? 'Checked' : '' }}>
                        ...
                        <div class="form-check mt-3 col-md-2 div_smo mb-3">
                            <input class="form-check-input" type="checkbox" name="smo_platfrom[]" value="Instagram"
                                id="instagran"
                                {{ $data->smo_on && in_array('Instagram', json_decode($data->smo_on)) ? 'Checked' : '' }}>
                        ...
                        <div class="form-check mt-3 col-md-2 div_smo mb-3">
                            <input class="form-check-input" type="checkbox" name="smo_platfrom[]" value="Twitter"
                                id="twitter"
                                {{ $data->smo_on && in_array('Twitter', json_decode($data->smo_on)) ? 'Checked' : '' }}>
                        ...
                        <div class="form-check mt-3 col-md-2 div_smo mb-3">
                            <input class="form-check-input" type="checkbox" name="smo_platfrom[]" value="Youtube"
                                id="youtube"
                                {{ $data->smo_on && in_array('Youtube', json_decode($data->smo_on)) ? 'Checked' : '' }}>
                        ...
                        <div class="form-check mt-3 col-md-2 div_smo mb-3">
                            <input class="form-check-input" type="checkbox" name="smo_platfrom[]" value="Linkedin"
                                id="linkedin"
                                {{ $data->smo_on && in_array('Linkedin', json_decode($data->smo_on)) ? 'Checked' : '' }}>
                ...
                {{-- <div class="row" id="div_mobile_application">
                    <div class="col-md-6 mb-3">
                        <label class="form-label" for="mobile_app_platform">{{ __('Platform ') }}<span
                                class="text-danger">*</span></label>
                        <select text="text" name="mobile_app_platform" id="mobile_app_platform"
                            class="form-control">
                            ...
                            @foreach ($mobile as $i => $val)
                                <option value="{{ $i }}" {{ $i == $data->platform_name ? 'Selected' : '' }}>
                                    {{ $val }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="preferred_technology" id="preferred_technology" class="form-control">
                            ...
                            @foreach ($t_preferred as $i => $val)
                                <option value="{{ $i }}"
                                    {{ $i == $data->prefer_technology ? 'Selected' : '' }}>{{ $val }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                {{-- <div class="row" id="div_customised_platforms">
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea type="text" name="cus_project_description" id="cus_project_description" class="form-control"
                            placeholder="Project details">{{ $data->others }}</textarea>
                    </div>
                </div> --}}
