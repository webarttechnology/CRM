...
<div class="modal-body">
        ...
        @if ($sales_data)
         <form method="post" action="{{ route('sales.update.suceess') }}" class="form-save">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                    ...
                                    <select name="client_id" id="client_id" class="form-control">
                                        ...
                                        <option value="{{ $val['id'] }}" {{ $sales_data?->client_id == $val['id']?'Selected':'' }}>{{ $val['name'].' ('.$val['client_code'].')' }}</option>
                                        @endforeach    
                                    </select>
                             ...
                             <div class="col-md-3 mb-3">
                              <a href="javascript:void(0)" class="btn btn-sm btn-primary mt-4 add-client-modal" data-bs-toggle="modal" data-bs-target="#add_client_modal">Add Client</a>
                             </div>  
                            <div class="col-md-5 mb-3">
                                    <label class="form-label" for="project_name">{{ __("Project Name") }} <span class="text-danger">*</span></label>
                                    <input  type="text" name="project_name" id="project_name" class="form-control" placeholder="Project name" value="{{ $sales_data?->project_name }}"/>
                            ...
                            <div class="col-md-12 mb-3">
                                    ...
                                    <select name="project_type" id="project_type" class="form-control" onchange="projectTypechangeEvent()">
                                        ...
                                        <option value="{{ $key }}" {{ $sales_data?->project_type == $key?'Selected':'' }}>{{ $val }}</option>
                                        @endforeach    
                                    </select>
                        ...
                        <div class="row" id="div_website">
                               <div class="col-md-6 mb-3" >
                                    ...
                                    <select name="technology" id="technology" class="form-control">
                                        ...
                                        <option value="{{ $i  }}" {{ $i == $sales_data?->technology ?'Selected':"" }}>{{ $val }}</option>
                                        @endforeach       
                                    </select>
                               </div>  
                               <div class="col-md-6 mb-3" >
                                    ...
                                    <select name="type" id="type" class="form-control" onchange="customerOnchangeEvent()">
                                        ...
                                        <option value="{{ $i  }}" {{ $i == $sales_data?->type ?'Selected':"" }}>{{ $val }}</option>
                                        @endforeach    
                                    </select>
                               </div>  
                               <div class="col-md-12 mb-3" id="div_customer_requirment">
                                    ...
                                    <input name="customer_requerment" id="customer_requerment" class="form-control" placeholder="Custom Requirements" value="{{ $sales_data?->customer_requerment }}">        
                               </div>   
                          ...
                          <div class="rowd" id="div_digital_marketing">
                                <div class="row">
                                    <div class="mt-3 col-md-1 mb-3">
                                      <div class="form-check">
                                            <input type="radio" name="digital_marketing" id="seo" value="SEO" {{ $sales_data?->marketing_plan == "SEO"?'Checked':'' }} class="form-check-input" onclick="smonclickEvent()" >
                                            <label class="form-label" for="seo">{{ __("SEO") }}</label>
                                      </div>
                                    </div>
                                    <div class="form-check mt-3 col-md-1 mb-3">
                                            <input type="radio" name="digital_marketing" id="smo" value="SMO" {{ $sales_data?->marketing_plan == "SMO"?'Checked':'' }} class="form-check-input" onclick="smonclickEvent()">
                                            <label class="form-label" for="smo">{{ __("SMO") }} </label>
                                    </div>
                                    <div class="form-check mt-3 col-md-2 mb-3">
                                            <input type="radio" name="digital_marketing" id="seo_smo" value="SEO_SMO" {{ $sales_data?->marketing_plan == "SEO_SMO"?'Checked':'' }} class="form-check-input" onclick="smonclickEvent()">
                                            <label class="form-label" for="seo_smo">{{ __(" SEO + SMO") }} </label>
                                    </div>
                                    <div class="form-check mt-3 col-md-2 mb-3">
                                            <input type="radio" name="digital_marketing" id="google_ads"  value="Google Ads" {{ $sales_data?->marketing_plan == "Google Ads"?'Checked':'' }} class="form-check-input" onclick="smonclickEvent()">
                                ...
                                <div class="row mb-3">
                                    <div class="mt-3 col-md-2 div_smo mb-3">
                                      <input class="form-check-input" type="checkbox" name="smo_platfrom[]" value="Facebook" id="facebook" {{ $sales_data?->smo_on && in_array('Facebook', json_decode($sales_data->smo_on))?'Checked':'' }}>
                                      <label class="form-check-label" for="facebook"> Facebook </label>
                                    </div>

                                    <div class="form-check mt-3 col-md-2 div_smo mb-3">
                                      <input class="form-check-input" type="checkbox" name="smo_platfrom[]" value="Instagram" id="instagran" {{ $sales_data?->smo_on && in_array('Instagram', json_decode($sales_data->smo_on))?'Checked':'' }}>
                                      <label class="form-check-label" for="instagran"> Instagram </label>
                                    </div>

                                    <div class="form-check mt-3 col-md-2 div_smo mb-3">
                                      <input class="form-check-input" type="checkbox" name="smo_platfrom[]" value="Twitter" id="twitter" {{ $sales_data?->smo_on && in_array('Twitter', json_decode($sales_data->smo_on))?'Checked':'' }}>
                                      <label class="form-check-label" for="twitter"> Twitter </label>
                                    </div>

                                    <div class="form-check mt-3 col-md-2 div_smo mb-3">
                                      <input class="form-check-input" type="checkbox" name="smo_platfrom[]" value="Youtube" id="youtube" {{ $sales_data?->smo_on && in_array('Youtube', json_decode($sales_data->smo_on))?'Checked':'' }}>
                                      <label class="form-check-label" for="youtube"> Youtube </label>
                                    </div>

                                    <div class="form-check mt-3 col-md-2 div_smo mb-3">
                                      <input class="form-check-input" type="checkbox" name="smo_platfrom[]" value="Linkedin" id="linkedin" {{ $sales_data?->smo_on && in_array('Linkedin', json_decode($sales_data->smo_on))?'Checked':'' }}>
                          ...
                          <div class="row" id="div_hosting">
                                  <div class="col-md-6 mb-3">
                                    ...
                                    <input  type="date" name="start_date" id="start_date" class="form-control" value="{{ date("Y-m-d", strtotime($sales_data?->start_date))  }}">                                        
                                  </div>  
                                  <div class="col-md-6 mb-3">
                                    <label class="form-label" for="end_date">{{ __("End Date") }} <span class="text-danger">*</span></label>
                                    <input  type="date" name="end_date" id="end_date" class="form-control" value="{{ date("Y-m-d", strtotime($sales_data?->end_date))  }}">                                            
                                  </div>
                          </div>
                          ...
                          <div class="row" id="div_mobile_application">
                                <div class="col-md-6 mb-3" >
                                          ...
                                          <select text="text" name="mobile_app_platform" id="mobile_app_platform" class="form-control" >
                                              ...
                                              <option value="{{ $i  }}" {{ $i == $sales_data?->platform_name?'Selected':''}}>{{ $val }}</option>
                                              @endforeach    
                                          </select>
                                  </div> 
                                  <div class="col-md-6 mb-3" >
                                    ...
                                    <select name="preferred_technology" id="preferred_technology" class="form-control">
                                        ...
                                        <option value="{{ $i  }}" {{ $i == $sales_data?->prefer_technology?'Selected':''}}>{{ $val }}</option>
                                        @endforeach    
                                    </select>
                               </div>   
                          ...
                          <div class="row" id="div_customised_platforms">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea  type="text" name="cus_project_description" id="cus_project_description" class="form-control" placeholder="Project description">{{ $sales_data?->others }}</textarea>                                
                            </div>  
                          </div>
                          ...
                          <div class="row" id="div_video_graphics">
                              <div class="col-md-12 mb-3">
                                          ...
                                          <textarea  type="text" name="gra_project_description" id="gra_project_description" class="form-control" placeholder="Project Description">{{ $sales_data?->others }}</textarea>
                          ...
                          <div class="row" id="div_ui_ux">
                              <div class="col-md-12 mb-3">
                                  ...
                                  <textarea  type="text" name="ui_project_description" id="ui_project_description" class="form-control" placeholder="Project description">{{ $sales_data?->others }}</textarea>               
                              </div>
                          </div>
                          <div class="row">
                              <div class="col-md-6 mb-3">
                                    <label class="form-label" for="business_name">{{ __("Business Name") }} <span class="text-danger">*</span></label>
                                    <input  type="text" name="business_name" id="business_name" class="form-control" placeholder="Business name" value="{{ $sales_data?->business_name }}">          
                              ...
                              <div class="col-md-6 mb-3" >
                                    ...
                                    <input type="text" name="closer_name" id="closer_name" class="form-control" placeholder="Closer name" value="{{ $sales_data?->closer_name }}">     
                               ...
                               <div class="col-md-6 mb-3" >
                                    ...
                                    <input type="text" name="agent_name" id="agent_name" class="form-control" placeholder="Agent name" value="{{ $sales_data?->agent_name }}">     
                               ...
                               <div class="col-md-6 mb-3" >
                                    ...
                                    <input type="text" name="reference_site" id="reference_site" class="form-control" placeholder="Reference Sites" value="{{ $sales_data?->reference_sites }}"/>              
                               </div>   
                              ...
                              <div class="col-md-12 mb-3">
                                          ...
                                          <input  type="text" name="upsale" id="upsale" class="form-control" placeholder="Upsale opportunities" value="{{ $sales_data?->upsale_opportunities }}">       
                              </div>
                              <div class="col-md-6 mb-3">
                                ...
                                <select name="currency" id="currency" class="form-control">
                                    ...
                                    <option value="{{ $key }}" {{ $key == $sales_data?->currency?'Selected':'' }}>{{ $val }}</option>
                                    @endforeach                                   
                                </select>
                              ...
                              <div class="col-md-6 mb-3">
                                    ...
                                    <input  type="number" name="gross_amt" id="gross_amt" class="form-control pendingamount" placeholder="$" value="{{ $sales_data?->gross_amount }}">  
                              ...
                              <div class="col-md-6 mb-3">
                                    ...
                                    <input  type="number" name="net_amt" id="net_amt" class="form-control pendingamount" placeholder="$" value="{{ $sales_data?->net_amount }}">  
                              ...
                              <div class="col-md-6 mb-3">
                                    ...
                                    <input  type="text" readonly name="due_amt" id="due_amt" class="form-control" placeholder="$" value="{{ $sales_data?->gross_amount - $sales_data?->net_amount }}">              
                              </div>
                              <div class="col-md-6 mb-3">
                              ...
                              <div class="col-md-6 mb-3" >
                                    ...
                                    <select name="payment_mode" id="payment_mode" class="form-control" onchange="paymentonchangeevent()">
                                        ...
                                        <option value="{{ $i }}" {{ $sales_data?->payment_mode == $i?'Selected':'' }}>{{ $val }}</option>
                                        @endforeach    
                                    </select>
                               ...
                               <div class="col-md-12 mb-3" id="div_other_pay">
                                    ...
                                    <input  type="text" name="other_pay" id="other_pay" class="form-control" placeholder="Description" value="{{ $sales_data?->other_pay }}">              
                              </div>
                          </div>  
                         <div class="row">
