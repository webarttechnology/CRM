...
class CollectionController extends Controller
{
    ...
    public function collectionlist(Request $request){
        if($request -> method() == "POST"){
            ...
            $paymentMode = payment_mode();           
            return view("admin.collection_list", ['data' => $data, 'currency' => currency(), 'instalment' => instalment(), 'paymentmode' => $paymentMode]);
        }
    ...
    public function addcollection(Request $request){
        if($request -> method() == "POST"){
            ...
            return view("admin.add_collection", ['clients' => \App\Models\Client::select(['name', 'id', 'client_code']) -> get()]);
        }
    ...
    public function updatecollection(Request $request, $updateid= ''){
        if($request -> method() == "POST"){
            ...
            return view("admin.update_collection", ['clients' => \App\Models\Client::select(['name', 'id', 'client_code']) -> get(), 'data' => $data, 'project' => $project]);
        }
